            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Modification Client </h4><br><br>
                        ...
                        <form method="post" action="{{ route('customer.update') }}" id="myForm"
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Adresse
                                </label>
                                <div class="form-group col-sm-10">
                            ...
                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Modification">
                        </form>
