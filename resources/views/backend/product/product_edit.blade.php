            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Modification </h4><br><br>
                        ...
                        <form method="post" action="{{ route('product.update') }}" id="myForm">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Produict </label>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Unite(Poids) </label>
                                <div class="col-sm-10">
