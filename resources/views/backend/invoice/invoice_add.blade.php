                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">N° de facture</label>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('invoice.store') }}">
                            ...
                            <table class="table-sm table-bordered" width="100%" style="border-color: #ddd;">
                                ...
                                <tbody>
                                <tr>
                                    <td colspan="4"> (Rabais) Discount</td>
                                    <td>
                            ...
                            <div class="row ">
                                <div class="form-group col-md-3">
                                    <label for="">Statut payant (Paid Status)</label>
                                    <select name="paid_status" id="paid_status"  class="form-select">
                                        <option value="" >Sélectionnez Statut</option>
                                        <option value="full_paid" >Entièrement payé (full_paid)</option>
                                        <option value="full_due">Plein d’intérêt (full_due)</option>
                                        <option value="partial_paid">Partiellement payé(partial_paid)</option>
                                    </select> <br>
                                    <input type="text" class="form-control paid_amount" id="paid_amount" placeholder="Entrez le montant payé" style="display:none">
                                </div>
                                ...
                                <label for="">Client</label>
                                    <select name="customer_id" id="customer_id"  class="form-select">
                                        ...
                                        @foreach ($costomer as $cos)
                                            <option value="{{$cos->id}}" >{{ $cos->name }}-{{ $cos->mobile_no }}-{{ $cos->email }}-{{ $cos->address }}</option>
                                        @endforeach
                                        <option value="0">Nouveau client </option>
                                        
                                
                                    </select> 
                                </div><br> <!-- </div><br> en row -->
                               
                            

                            <!-- Masquer Ajouter un formulaire client -->
                                <div class="row new_customer" style="display: none;">
                                    <div class="form-group col-md-4">
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Entre votre nom">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Entre votre Telephone">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <input type="text" name="email" id="email" class="form-control" placeholder="Entre votre Email">
                                    </div>
                                </div><br><!-- Masquer Ajouter un formulaire client -->
