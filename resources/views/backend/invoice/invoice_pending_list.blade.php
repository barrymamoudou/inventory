                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- Vérifier si le client et la relation payment existent -->
                                    <td>
                                    ...
                                    <!-- Vérifier si la relation payment existe avant d'afficher le montant -->
                                    <td>
                                        @if($item->payment)
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('purchase.delete', $item->id) }}" class="btn btn-danger sm" title="Delete Data" id="delete">
